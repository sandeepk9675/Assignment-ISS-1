...
int main(int argc, char **argv)
{
    ...
    /*string hashtagsPath = "input_product.csv";
    string purchasesPath = "input_customer.csv";
    string pricesPath = "input_price.csv";
    string groupsPath = "input_groups.csv";
    string outputPath = "output1.csv";  // File path for output file
    string outputPath2 = "output2.csv"; // File path for output file
    string outputPath3 = "D:/Academics/DS221 Introduction to scalable systems/Assignment/Assignment 1/tests_q1";    //  Folder path for output files
    string newHashtagPath = "input_newhashtags.csv";
    */
    /*./main.exe ./input_product.csv ./input_customer.csv ./input_price.csv ./input_groups.csv ./output1.csv ./output.csv ./D:/Academics/DS221 Introduction to scalable systems/Assignment/Assignment 1/tests q1 ./input_newhashtags.csv*/
